...
Currently authentication is handled by an API key. The app sends the API key in header along with other data. Backend then verifies the API key and accepts request only if it matches.
