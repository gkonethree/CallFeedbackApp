...
\begin{itemize}
    ...
    \item \textbf{Audio Issues} Multiple selectable options including Call Dropped, Can't Hear them, They can't hear, background noise, echo.
